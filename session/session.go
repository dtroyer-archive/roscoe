...
// Token access from Session
type TokenInterface interface {
	GetTokenId() string
}

// Generic callback to get a token from the auth plugin
type AuthFunc func(interface{}) (TokenInterface, error)
...
func NewSession(af AuthFunc, tls *tls.Config) (session *Session, err error) {
	tr := &http.Transport{
		TLSClientConfig:    tls,
...
// These top-level functions create a default Session with no auth
